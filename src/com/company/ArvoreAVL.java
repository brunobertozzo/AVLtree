...
public class ArvoreAVL {
    ...
    public boolean inserir(int chave) {
        ...
        while (true) {
            ...
            if (atual == null) {
                if (vaiParaEsquerda) {
                    pai.setEsquerda(new Noh(chave, pai));
                } else {
                    pai.setDireita(new Noh(chave, pai));
                }
                rebalancear(pai);
                break;
            }
     ...
     */
    private void removerRecursivo(Noh no) {
     ...
     */
    private void rebalancear(Noh no) {
        setBalanceamento(no);
     ...
     */
    private Noh rotacionaEsquerda(Noh noDesbalanceado) {

        Noh direita = noDesbalanceado.getDireita();
     ...
     * @param noDesbalanceado: nó a ser rotacionado
     */
    private Noh rotacionaDireita(Noh noDesbalanceado) {

        Noh esquerda = noDesbalanceado.getEsquerda();
     ...
     */
    private Noh rotacionaEsquerdaDepoisDireita(Noh no) {
     ...
     * @param no: nó a ser rotacionado
     */
    private Noh rotacionaDireitaDepoisEsquerda(Noh no) {
     ...
     */
    private void setBalanceamento(Noh... nos) {
        for (Noh no : nos) {
            calculaAltura(no);
     ...
     */
    private void imprimeArvoreInOrderRecursivo(Noh no) {
        if (no != null) {
     ...
     */
    private void calculaAltura(Noh no) {
        if (no != null) {
